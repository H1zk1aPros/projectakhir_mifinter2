...
<div class="col-sm-9">
    <form action="" method="POST" enctype="multipart/form-data" class="mt-9">
    <div class="row">
        <div class="col-md-3">&nbsp;
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-3">
            <label for="mem_group">Group</label><br>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        ...
        <div class="form-group">
            <input type="submit" class="btn btn-primary " name="create_member" value="Add Member" >
        </div>
    </form>
</div>
</div>
